 ...
 * Use the [ScanDialogFragment.newInstance] factory method to
...
class ScanDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_scan_dialog, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ScanDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ScanDialogFragment().apply {
