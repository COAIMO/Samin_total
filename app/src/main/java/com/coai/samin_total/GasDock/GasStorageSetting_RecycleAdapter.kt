...
import com.coai.samin_total.SetAqInfo

class GasStorageSetting_RecycleAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    var gasStorageInfo = mutableListOf<SetGasStorageViewData>()
    ...
    override fun getItemCount(): Int {
        return gasStorageInfo.size
    }


    fun submitList(viewData: MutableList<SetGasStorageViewData>) {
        this.gasStorageInfo = viewData
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as GasStorageSettingViewHodler).bind(gasStorageInfo[position])
    ...
    inner class GasStorageSettingViewHodler(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(gasStorageInfo: SetGasStorageViewData) {
            modelNum.text = gasStorageInfo.model.toString()
            idNum.text = gasStorageInfo.id.toString()
            sensorNum.text = gasStorageInfo.port.toString()
        }
    }
}